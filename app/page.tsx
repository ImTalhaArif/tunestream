      ...
      <main className="flex-1 p-8">
        ...
        <section className="mt-12">
          ...
          <div className="flex gap-4 flex-wrap justify-center">
            <button className="bg-purple-900 px-6 py-3 rounded-lg hover:bg-purple-700">MOBA</button>
            <button className="bg-purple-900 px-6 py-3 rounded-lg hover:bg-purple-700">FPS</button>
            <button className="bg-purple-900 px-6 py-3 rounded-lg hover:bg-purple-700">Pop</button>
            <button className="bg-purple-900 px-6 py-3 rounded-lg hover:bg-purple-700">EDM</button>
          </div>
        </section>
        ...
        <section className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-gradient-to-tr from-[#1a052e] via-purple-800 to-[#0f011c] p-6 rounded-xl flex flex-col items-center">
            <img src="https://source.unsplash.com/200x200/?gamer" alt="Gamer" className="w-32 h-32 rounded-full mb-4" />
            <p className="text-xl font-bold">Ninja</p>
            <p className="text-sm text-gray-300">Streaming</p>
          </div>
          <div className="bg-gradient-to-tr from-[#1a052e] via-purple-800 to-[#0f011c] p-6 rounded-xl flex flex-col items-center">
            <img src="https://source.unsplash.com/200x200/?music,dj" alt="Music" className="w-32 h-32 rounded-full mb-4" />
